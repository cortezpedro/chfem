...
// reduce_gtthreshold_values_with_stride_and_scale --- res = sum(scl*v[v>t])
// reduce_lethreshold_values_with_stride_and_scale --- res = sum(scl*v[v<=t])
...
template<typename T> __global__ void kernel_reduce_gtthreshold_values_with_stride_and_scale(T *v, unsigned int n, unsigned int stride, unsigned int shift, T scl, T t, double *res);   // res = sum(scl*v[v>t])
template<typename T> __global__ void kernel_reduce_lethreshold_values_with_stride_and_scale(T *v, unsigned int n, unsigned int stride, unsigned int shift, T scl, T t, double *res);   // res = sum(scl*v[v<=t])
